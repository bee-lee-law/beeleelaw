    ...
    <Wrapper isMobile={isMobile} pageTitle={pageTitle} pageDescription={pageDescription}>
      <main className={styles.main}>
        <Card style={{width: '80vw'}} minimizeable={false}>
          <div className={isMobile ? styles.innerCardMobile : styles.innerCardDesktop}>
          <Image style={{background: 'white', borderRadius: '1rem', margin: 'auto'}}
                            src={selfie}
                            width={imageSize}
                            height={'auto'}
                            alt='Brandon Lawrence portrait'
          /> 
          <span className={isMobile ? styles.cardContentMobile : styles.cardContentDesktop}>
            ...
            The intent of this project is to provide information about myself and host a kind of portfolio.
            <br />
            <strong>My goals include:</strong>
            <ul style={{marginTop: 'var(--spacing-2)', marginBottom: 'var(--spacing-2)', lineHeight: '1.8'}}>
              <li style={{marginBottom: 'var(--spacing-1)'}}>Show off who I am</li>
              <li style={{marginBottom: 'var(--spacing-1)'}}>Showcase front-end development and React skills by creating a web-app that looks visually cohesive on mobile and desktop</li>
              <li style={{marginBottom: 'var(--spacing-1)'}}>Utilize Amazon Web Services to get hands-on practice with the cloud while studying for AWS certifications</li>
              <li style={{marginBottom: 'var(--spacing-1)'}}>Use my data and development skills to create some interactive tools</li>
              <li style={{marginBottom: 'var(--spacing-1)'}}>Host my personal projects</li>
            </ul>
          </span>
